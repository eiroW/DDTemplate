...
class FiberRegistor:
    def __init__(self,
                 ...
                 model_path: str = 'path/to/models/models_sep/snapshot100_alltracts_half_8to2_whole.pt',
                 data_path: str = 'path/to/datasets/HCP_100',
                 device: str = 'cuda:7',
                 batch_size: int = 6,
                 sub_num: int = 10,
                 tracts_num=-1
        ...
        self.root_dir = 'path/to/results/tracts_related'
        self.device = device
        self.tracts = tracts
...
if __name__ =='__main__':
    ...
    arg.add_argument('--model_path',type=str,default='path/to/models/whole_model.pt')
    arg.add_argument('--data_path',type=str,default='path/to/datasets/HCP_100')
